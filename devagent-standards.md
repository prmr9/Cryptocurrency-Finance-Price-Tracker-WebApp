...
- Refresh the branch against its base before implementing a dependent ticket _(confirmed 7x)_
- Only bump a dependency to a version the registry actually publishes _(confirmed 16x)_
